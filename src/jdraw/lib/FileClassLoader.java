package jdraw.lib; /**
 * @(#)jdraw.lib.FileClassLoader.java	1.0 12/09/2008
 */
...
/**
 * jdraw.lib.FileClassLoader extends URLClassLoader to provide functionality for
...
public class FileClassLoader extends URLClassLoader {
   ...
   /**
    * Constructs a new jdraw.lib.FileClassLoader with the default delegation parent
    * ClassLoader.  URLs can be added to the jdraw.lib.FileClassLoader using the
    * addURL(URL) method.
    * <P>
    * This constructor invokes jdraw.lib.FileClassLoader(URL[]) with an empty URL array.
    * 
    * @see #addURL(java.net.URL)
    * @see #FileClassLoader(java.net.URL[])
    */
   ...
   /**
    * Constructs a new jdraw.lib.FileClassLoader for the specified URLs with the default
    * delegation parent ClassLoader.
    * <P>
    * This constructor invokes jdraw.lib.FileClassLoader(URL[], ClassLoader) with the
    * URLs and a null parent.
    * 
    * @param urls the URLs from which to load classes and resources
    * @see #FileClassLoader(java.net.URL[] urls, ClassLoader)
    */
   ...
   /**
    * Constructs a new jdraw.lib.FileClassLoader using the specified delegation parent
    * ClassLoader.  URLs can be added to the jdraw.lib.FileClassLoader using the
    * addURL(URL) method.
    * <P>
    ...
    * <P>
    * This constructor invokes jdraw.lib.FileClassLoader(URL[], ClassLoader) with an
    * empty URL array and the specified parent.
    * 
    * @param parent the parent class loader for delegation
    * @see #addURL(java.net.URL)
    * @see #FileClassLoader(java.net.URL[], ClassLoader)
    */
   ...
   /**
    * Constructs a new jdraw.lib.FileClassLoader for the specified URLs using the
    ...
    * @param urls the URLs from which to load classes and resources
    * @param parent the parent class loader for delegation
    * @see java.net.URLClassLoader#URLClassLoader(java.net.URL[], ClassLoader)
    */
